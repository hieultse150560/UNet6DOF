...
from UnetMediumRefined import SpatialSoftmax3D, UNet6DOFmedium_refined
...
parser.add_argument('--exp', type=str, default='singlePeople_UnetMediumRefined_13_12', help='Name of experiment')
