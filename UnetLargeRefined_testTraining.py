...
parser.add_argument('--exp', type=str, default='singlePeople_UnetLargeRefined_TestTraining', help='Name of experiment')
...
#                                    "loss_keypoint:", loss_keypoint.cpu().data.numpy())
        ...
        stop = time.time()
        print(f"Evaluation with Eva Set: {stop - start}s")
