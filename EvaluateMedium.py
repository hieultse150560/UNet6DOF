...
parser.add_argument('--exp', type=str, default='singlePeople_UnetMedium_30_11', help='Name of experiment')
...
checkpoint = torch.load(args.exp_dir + 'ckpts/' + args.exp + '_' + str(args.lr)
                        + '_' + str(args.window) + '_cp99' + '.path.tar')
...
for i_batch, sample_batched in bar(enumerate(test_dataloader, 0)):
    ...
    if i_batch % 100 == 0 and i_batch != 0:
        ...
        if args.exp_image:
            ...
            generateImage(imageData, args.exp_dir + 'predictions/image/', args.exp + "_cp99_", i_batch//100, base)
...
if args.exp_L2:
    ...
    pickle.dump(dis, open(args.exp_dir + 'predictions/L2/'+ args.exp + '_dis_cp99.p', "wb"))
